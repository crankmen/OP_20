...
export class MyToken extends DeployableOP_20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
        const maxSupply: u256 = u256.fromString('100000000000000000000000'); // Your max supply. (Here, 1 billion tokens)
        const decimals: u8 = 2; // Your decimals.
        const name: string = 'PINGVI'; // Your token name.
        const symbol: string = 'PNGV'; // Your token symbol.
