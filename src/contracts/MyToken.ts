...
export class MyToken extends DeployableOP_20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
        const maxSupply: u256 = u256.fromString('10000000'); // Your max supply. (Here, 1 billion tokens)
        const decimals: u8 = 18; // 1.
        const name: string = 'Test'; // crank707.
        const symbol: string = 'TEST'; // crnk.
